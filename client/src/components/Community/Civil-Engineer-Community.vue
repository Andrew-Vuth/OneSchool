                ...
                <div class="cover-container">
                    <div class="cover-box">
						<div class="cover-item">
							<h5 class="card-title">Civil Engineer Community</h5>
								<p class="card-text">This is Civil Engineer Community. We love to see all of civil engineer students aroud the world to share your issue here and solution here.

                                </p>
								<div class="button">
									<a href="/invite" class="btn btn-sm">+ invite</a>
								</div>
						</div>
					</div>
                </div>
...
<script>
    ...
    import postItemForCivilEngineer from "../Community/PostItemForCivilEngineer.vue"
